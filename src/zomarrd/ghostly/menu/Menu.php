...
use zomarrd\ghostly\menu\serverselector\ServerSelectorGUIOld;
 ...
 * @method static ServerSelectorGUIOld SERVER_SELECTOR_GUI()
 */
class Menu
{
	use EnumTrait;
	...
	protected static function setup(): void
	{
		...
		self::_registryRegister('server_selector_gui', new ServerSelectorGUIOld());
	}
}
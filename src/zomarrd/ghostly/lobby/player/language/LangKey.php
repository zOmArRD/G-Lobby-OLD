...
final class LangKey
{
	...
	public const FORM_SAVE = "form.save";
	public const FORM_SUBMIT = "form.submit";
	public const ITEM_COSMETICS_SELECTOR = "item.cosmetics-selector";
	public const ITEM_LOBBY_SELECTOR = "item.lobby-selector";
	public const ITEM_PLAYER_SETTINGS = "item.player-settings";
	public const ITEM_QUEUE_EXIT = "item.queue-exit";
	public const ITEM_SERVER_SELECTOR = "item.server-selector";
	public const ITEM_VISIBILITY_ALL = "item.visibility-all";
	public const ITEM_VISIBILITY_FRIENDS = "item.visibility-friends";
	public const ITEM_VISIBILITY_NONE = "item.visibility-none";
	...
	public const SERVER_ISNT_LOBBY = "server.isnt-lobby";
	public const SERVER_NOT_AVAILABLE = "server.not-available";

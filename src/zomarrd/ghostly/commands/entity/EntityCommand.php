...
final class EntityCommand extends BaseCommand
{
    ...
    protected function prepare(): void
    {
        ...
        $this->registerSubCommand(new EntityCreateCommand('create', 'Create an entity'));
        $this->registerSubCommand(new EntityKillCommand('kill', 'Delete entities, purge them all LOL', ['purge']));
    }
}
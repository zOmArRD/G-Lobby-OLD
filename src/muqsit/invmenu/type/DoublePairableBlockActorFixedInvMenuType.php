...
final class DoublePairableBlockActorFixedInvMenuType implements FixedInvMenuType
{
    ...
    public function createGraphic(InvMenu $menu, Player $player): ?InvMenuGraphic
    {
        ...
        foreach ([[$origin, $origin->east()], [$origin->east(), $origin]] as [$origin_pos, $pair_pos]) {
            $graphics[] = new BlockActorInvMenuGraphic($this->block, $origin_pos, BlockActorInvMenuGraphic::createTile($this->tile_id, $menu_name)->setInt(Chest::TAG_PAIRX, $pair_pos->x)->setInt(Chest::TAG_PAIRZ, $pair_pos->z), $this->network_translator, $this->animation_duration);
        }
